...
public class OrderedProductController {
    ...
    @GetMapping("/status")
    public ResponseEntity<List<OrderedProductResponseDto>> getOrderedProducts(@ModelAttribute OrderedProductStatusRequestDto OrderedProductStatusRequestDto) {
        ...
        List<OrderedProductResponseDto> orderedProductResponseDtoList = orderedProductService.getOrderedProducts(orderedProductStatusQuery);
        return ResponseEntity.ok(orderedProductResponseDtoList);
    }
}
