...
public class OrderedProductController {
    ...
    @ApiResponse(responseCode = "404", description = "존재하지 않는 주문 상품입니다.", content = @Content)
    @GetMapping("/{id}")
    ...
    @ApiResponse(responseCode = "403", description = "관리자 권한 필요합니다.", content = @Content)
    @ApiResponse(responseCode = "404", description = "존재하지 않는 주문 상품입니다.", content = @Content)
    ...
    @ApiResponse(responseCode = "400", description = "취소 실패", content = @Content)
    @ApiResponse(responseCode = "403", description = "로그인이 필요합니다.", content = @Content)
    @ApiResponse(responseCode = "404", description = "존재하지 않는 주문 상품입니다.", content = @Content)
